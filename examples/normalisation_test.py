...
if __name__ == '__main__':
    ...
    fit_model.add_component('signal', scipy.stats.uniform, loc=1.0, scale=2.0, norm=0.5)
    ...
    data = fit_model.frozen_distribution.rvs(size=100000)
    plot_data_and_model("Model with true parameters", data, fit_model)
    print(fit_model.parameters)

    fit_model.set_parameters(signal_loc=0.9, background_loc=1.9, signal_norm=0.5)
